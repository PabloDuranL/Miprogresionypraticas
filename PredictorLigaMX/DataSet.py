# -*- coding: utf-8 -*-
"""
Created on Fri Jul 24 14:19:46 2026
        ...
        with open(archivo, encoding="utf8") as f:
            ...
            for linea in f:
                ...
                if m:
                    ...
                    # Valores por defecto: marcador normal
                    ...
                    # Si el partido terminó en penales
                    if "pen." in linea.lower():

                        penales = True

                        # Marcador de la tanda
                        pen_local = goles_local
                        pen_visitante = goles_visitante

                        # Buscar el marcador del partido antes de los penales
                        marcador = re.search(r"\((\d+)-(\d+)", linea)
                    ...
                    partidos.append({
                        ...
                        # Marcador del partido (90' o tiempo extra)
                        "goles_local": goles_local,
                        "goles_visitante": goles_visitante,

                        # Información de penales
                        "penales": penales,
                        "pen_local": pen_local,
                        "pen_visitante": pen_visitante
